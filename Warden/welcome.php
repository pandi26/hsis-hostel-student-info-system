...
if (isset($_SESSION['last_activity']) && (time() - $_SESSION['last_activity'] > $_SESSION['expire_time'])) {
    ...
    header("location: warden_login.php?session_expired=true"); // Redirect to login with session expired flag
    exit;
}
    ...
    <main>
        <section class="container">
            <div class="dashboard-card">
                <h2 class="display-4">Welcome, Warden <?php echo htmlspecialchars($_SESSION['username']); ?>!</h2>
