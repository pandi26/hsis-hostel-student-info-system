    ...
    <header><h2>HSIS</h2>
        <nav class="navbar">
            ...
            <ul class="links">
                ...
                <li><a href="add_warden.php">Add warden</a></li>
                <li><a href="warden.php">warden details</a></li>
    ...
    <main>
        <section class="container">
            <div class="dashboard-card">
                <h2 class="display-4">Welcome, Admin <?php echo htmlspecialchars($_SESSION['username']); ?>!</h2>
